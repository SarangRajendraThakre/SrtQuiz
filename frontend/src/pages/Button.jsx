...
const Button = () => {
  return (
    <>
      <ButtonCard icon={<IoTriangleSharp fontSize="35px" color="white" />} colorClass="color1" />
      <ButtonCard icon={<FaSquareFull fontSize="20px" color="white" />} colorClass="color2" />
      <ButtonCard icon={<BsDiamondFill fontSize="35px" color="white" />} colorClass="color3" />
      <ButtonCard icon={<FaCircle fontSize="35px" color="white" />} colorClass="color4" />
    </>
  );
};

const ButtonCard = ({ icon, colorClass }) => {
  ...
  const handleTyping = (e) => {
    setIsTyping(e.target.innerText.trim().length > 0);
  };
...
>
<p dir="ltr"><span data-lexical-text="true">g</span></p>
</div>
